...
export const ListaContacto = () => {
  ...
  return (
    <div className="container-fluid" style={{ backgroundColor: '#f8f9fa', minHeight: '100vh', padding: '10px 15px' }}>
      <div className="row justify-content-center">
        <div className="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-5">
          
          {/* Botón Add new contact - Responsive */}
          <div className="d-flex justify-content-end mb-3 mb-md-4">
            <Link to="/add-contact" className="btn btn-success px-3 px-md-4">
          ...
          <div className="bg-white rounded shadow-sm">
                  ...
                  <div className="row align-items-center">
                    ...
                    <div className="col-6 col-sm-7 col-md-8">
                      <div className="ms-2 ms-md-3">
                        <h5 className="mb-1 mb-md-2 fw-bold text-dark" style={{ fontSize: 'clamp(1rem, 2.5vw, 1.25rem)' }}>
                          {contact.name}
                        </h5>
                        <div className="text-muted" style={{ fontSize: 'clamp(0.75rem, 2vw, 0.875rem)' }}>
                          {/* Dirección */}
                          <div className="mb-1 d-flex align-items-start">
                            <i className="fas fa-map-marker-alt me-2 mt-1 flex-shrink-0" style={{ width: '12px', fontSize: '0.75rem' }}></i>
                            <span className="text-truncate">{contact.address}</span>
                          </div>
                          
                          {/* Teléfono */}
                          <div className="mb-1 d-flex align-items-center">
                            <i className="fas fa-phone me-2 flex-shrink-0" style={{ width: '12px', fontSize: '0.75rem' }}></i>
                            <span className="text-truncate">{contact.phone}</span>
                          </div>
                          
                          {/* Email - Oculto en móviles muy pequeños */}
                          <div className="mb-0 d-flex align-items-center">
                            <i className="fas fa-envelope me-2 flex-shrink-0" style={{ width: '12px', fontSize: '0.75rem' }}></i>
                            <span className="text-truncate d-none d-sm-inline">{contact.email}</span>
            ...
            {store.contacts.length === 0 && !store.isLoading && (
              <div className="text-center py-4 py-md-5 px-3">
                <i className="fas fa-address-book mb-3" style={{ fontSize: 'clamp(2rem, 8vw, 3rem)', color: '#6c757d' }}></i>
                <h4 className="text-muted mb-2" style={{ fontSize: 'clamp(1.1rem, 4vw, 1.5rem)' }}>
                  No contacts yet
                </h4>
                <p className="text-muted mb-3" style={{ fontSize: 'clamp(0.875rem, 3vw, 1rem)' }}>
          ...
          <div className="modal-dialog modal-dialog-centered mx-3">
            <div className="modal-content">
              <div className="modal-header border-0">
                <h5 className="modal-title fw-bold" style={{ fontSize: 'clamp(1.1rem, 4vw, 1.25rem)' }}>
                  Are you sure?
                </h5>
                <button 
                  type="button" 
              ...
              <div className="modal-body">
                <p className="mb-0" style={{ fontSize: 'clamp(0.875rem, 3vw, 1rem)' }}>
